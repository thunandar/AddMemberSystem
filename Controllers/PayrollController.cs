namespace AddMemberSystem.Controllers
{
    public class PayrollController : Controller
    {
        ...
        public PayrollController(AppDBContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public IActionResult List(int pg = 1)
        {
            ...
            List<TB_Payroll> result = _context.TB_Payrolls
               .Where(p => p.IsDeleted == false).OrderByDescending(s => s.PayrollPkid).ToList();
